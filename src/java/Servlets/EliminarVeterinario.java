 ...
 * @author Software
 */
//@WebServlet("/EliminarVeterinario")
public class EliminarVeterinario extends HttpServlet {
        ...
        (HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            try {
                ...
                veterinario.setIdentificacion(codigo);
                int resultado = logica.Eliminar(veterinario);
                String mensaje = logica.getMensaje();//Mensaje sp
                mensaje = URLEncoder.encode(mensaje, "UTF-8");
                //Redireccionar a la pagina jsp
                response.sendRedirect("FrmVeterinarios.jsp?mensaje=" + mensaje + "&resultado=" + resultado);
            } catch (Exception ex) {
