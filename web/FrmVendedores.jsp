<%-- 
    Document   : FrmVendedores
    Created on : 3 may 2022, 11:59:39
    Author     : Software
--%>
...
<html>
    ...
    <body>
        <nav class="navbar navbar-expand-sm navbar-toggleable-sm navbar-dark bg-dark border-bottom box-shadow mb-3">
            ...
            <form action="FrmVendedores.jsp" method="post">
            ...
            <table class="table table-dark table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="FrmMantVendedor.jsp?idCrearModificar=<%=codigo%>"> <i class="fas fa-user-edit"></i></a> |
                            <!--Botón para Eliminar -->
                ...
                <br> 
              <a href="FrmMantVendedor.jsp?idCrearModificar=-1"><button type="button" class="btn btn-dark mb-3">Agregar Vendedor</button></a> |
             <a href="FrmVendedores.jsp"><button type="button" class="btn btn-dark mb-3">Actualizar</button></a> |
