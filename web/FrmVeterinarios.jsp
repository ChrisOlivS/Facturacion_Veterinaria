<%-- 
    Document   : FrmVeterinarios
    Created on : 3 may 2022, 10:27:33
    Author     : Software
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <form action="FrmVeterinarios.jsp" method="post">
                ...
                <tbody>
                    ...
                    <% 
                        ...
                        if(request.getParameter("txtnombre")!=null){
                            ...
                            condicion = "NOMBRE_VETERINARIO LIKE '%" + nombre + "%'";
                        }
                        BLVeterinarios logica = new BLVeterinarios();
                        List<Veterinarios> datos;
                        datos = logica.Listar(condicion);
            
                        //for para llenar la tabla
                        for (Veterinarios registro:datos){
                    %>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="FrmMantVeterinarios.jsp?idCrearModificar=<%=codigo%>"><i class="fas fa-user-edit"></i></a> |
                            <!--Botón para Eliminar -->
                            <a href="EliminarVeterinario?idEliminar=<%=codigo%>"><i class="fas fa-trash-alt"></i></a>
                        </td>
                    </tr>
                    <%}%><!--Para cerrar el for --> 
                </tbody>
            ...
            <br>
                <%
                    //Codigo necesario para mostrar lo que devuelve el procedimiento almacenado
                    // meCli 
                    if(request.getParameter("mensaje")!=null) {
                            out.print("<p class='text-danger'>"+new String
                            (request.getParameter("mensaje").getBytes("ISO-8859-1"),"UTF-8")+"</p>");
                        }
                %>
             <a href="FrmMantVeterinarios.jsp?idCrearModificar=-1"><button type="button" class="btn btn-dark mb-3">Agregar Veterinario</button></a> |
             <a href="FrmVeterinarios.jsp"><button type="button" class="btn btn-dark mb-3">Actualizar</button></a> |
