<%-- 
    Document   : FrmCompras
    Created on : 3 may 2022, 11:45:48
    Author     : Software
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <form action="FrmCompras.jsp" method="post">
                <div class="form-group">
                    <div class="input-group">
                        <input type="text" id="txtnombre" name="txtnombre" value="" 
                               placeholder="Buscar Codigo Compra" class="form-control"/>
                        &nbsp;&nbsp;
                ...
                <tbody>
                    ...
                    <%
                        ...
                        if (request.getParameter("txtnombre") != null) {
                            ...
                            condicion = "ID_COMPRA LIKE '%" + nombre + "%'";
                        }
                        ...
                        for (Compras registro : datos) {
                    %>
                    <tr>
                        <% int codigo = registro.getCodigoCompra();%>
                        <td><%=codigo%></td>
                        <td><%=registro.getIdentificacionVeterinario()%></td>
                        ...
                        <td>
                            ...
                            <a href="FrmMantCompras.jsp?idCrearModificar=<%=codigo%>"> <i class="fas fa-user-edit"></i></a> |
                            <!--Botón para Eliminar -->
                            <a href="EliminarCompra?idEliminar=<%=codigo%>"> <i class="fas fa-trash-alt"></i></a>
                        </td>
                    </tr>
                    <%}%><!--Para cerrar el for --> 
                </tbody>
            ...
            <br> 
            <a href="FrmMantCompras.jsp?idCrearModificar=-1"><button type="button" class="btn btn-dark mb-3">Agregar Compra</button></a> |
            <a href="FrmCompras.jsp"><button type="button" class="btn btn-dark mb-3">Actualizar</button></a> |
