<%-- 
    Document   : FrmMantVendedor
    Created on : 8 may 2022, 21:45:26
    Author     : Software
--%>
<%@page import="Capa_Entidades.Vendedores"%>
<%@page import="Capa_Logica.BLVendedores"%>
...
<html>
    <head>
        ...
        <title>Mantenimiento Vendedores</title>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <%
                        ...
                        if (codigo > 0) {
                            vendedor = logica.Obtener("ID_VENDEDOR =" + id);
                        } else {
                    ...
                    <form action="CrearModificarVendedor" method="post" id="form_AgregarModificar">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="" name="txtcodigo" value="<%=vendedor.getIdentificacion()%>" readonly class="form-control">
                            <%} else {%>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="" name="txtNombre" value="<%=vendedor.getNombre()%>" class="form-control"><br>
                        </div>
                        <div class="form-group">
                            <label for="txtapellido1" class="control-label">Primer Apellido</label>
                            <input type="text" id="" name="txtApellido1" value="<%=vendedor.getApellido1()%>" class="form-control"> <br>
                        </div>
                        <div class="form-group">
                            <label for="txtapellido2" class="control-label">Segundo Apellido</label>
                            <input type="text" id="" name="txtApellido2" value="<%=vendedor.getApellido2()%>" class="form-control"><br>
                        </div>
                        <div class="form-group">
